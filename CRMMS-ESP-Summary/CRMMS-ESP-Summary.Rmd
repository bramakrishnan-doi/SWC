...
Last_month_file <- "CRMMS-ESP-Summary/PreviousMonth/EnsembleOutput.xlsx"       #In file path use either / or \\, do NOT use \
Current_month_file <- "CRMMS-ESP-Summary/CurrentMonth/EnsembleOutput.xlsx"

EOCY <- "2024-12-01"            #EOCY for Powell/Mead elevation ranges in summary points.
PowellOT_WYrn <- "2025-01-01"   #WY for Powell Operating Tier and Release Volume tables.
Year1 <- "2024-01-01"           #1st Yr Powell/MSCP tables. Code calculates Year2 (1st yr Mead tables).
...
Powell_Elev <- as.data.frame(read_excel(Current_month_file, sheet = "Powell.Pool Elevation"))
...
Mead_Elev <- as.data.frame(read_excel(Current_month_file, sheet = "Mead.Pool Elevation"))
...
* Projected Elevations:
  * Lake Powell EOCY `r EOCY_range` range: `r format(Powell_min, nsmall=2,big.mark=",")` feet – `r format(Powell_max, nsmall=2,big.mark=",")` feet
  * Lake Mead EOCY `r EOCY_range` range: `r format(Mead_min, nsmall=2,big.mark=",")` feet – `r format(Mead_max, nsmall=2,big.mark=",")` feet
...
PowellOT <- as.data.frame(read_excel(Current_month_file, sheet = "PowellData.ReleaseTier"))
rownames(PowellOT) <- PowellOT[,1]
PowellRel <- as.data.frame(read_excel(Current_month_file, sheet = "UpperBalancingAt823"))
rownames(PowellRel) <- PowellRel[,1]
PowellBelow <- as.data.frame(read_excel(Current_month_file, sheet = "UpperBalancingBelow823"))
rownames(PowellRel) <- PowellRel[,1]
PowellAbove <- as.data.frame(read_excel(Current_month_file, sheet = "UpperBalancingAbove823"))
rownames(PowellRel) <- PowellRel[,1]
...
tab_PowellOT <- data.frame(Eq, UEBT, UEBT823, UEBTB823, MERT, LEBT)
...
PowellRV <- as.data.frame(read_excel(Current_month_file, sheet = "PowellTargetAnnualReleaseVolume"))
...
Powell3525 <- as.data.frame(read_excel(Current_month_file, sheet = "Powell3525Annual"))
...
Powell3490 <- as.data.frame(read_excel(Current_month_file, sheet = "Powell3490Annual"))
...
LBDCP <- as.data.frame(read_excel(Current_month_file, sheet = "DCPBWSP_Type"))
...
Mead1075 <- as.data.frame(read_excel(Current_month_file, sheet = "AnnualShortageAnyTypeFlag"))
...
Mead1050 <- as.data.frame(read_excel(Current_month_file, sheet = "DCPBWSP_Type"))
...
Mead1045 <- as.data.frame(read_excel(Current_month_file, sheet = "DCPBWSP_Type"))
...
Mead1025 <- as.data.frame(read_excel(Current_month_file, sheet = "DCPBWSP_Type"))
...
Mead950 <- as.data.frame(read_excel(Current_month_file, sheet = "MeadData.MeadBelow950_Annual"))
...
Mead895 <- as.data.frame(read_excel(Current_month_file, sheet = "MeadData.MeadBelow895_Annual"))
...
PowellUnregInf <- as.data.frame(read_excel(Current_month_file, sheet = "PowellAJUnregInflow"))
rownames(PowellUnregInf) <- PowellUnregInf[,1]
PowellRT <- as.data.frame(read_excel(Current_month_file, sheet = "PowellData.ReleaseTier"))
...
Mead_Inflow <- as.data.frame(read_excel(Current_month_file, sheet = "Mead.Inflow"))
...
Mead_Outflow <- as.data.frame(read_excel(Current_month_file, sheet = "Mead.Outflow"))
...
LCShortage <- as.data.frame(read_excel(Current_month_file, sheet = "Shortage.Shortage Flag"))
rownames(LCShortage) <- LCShortage[,1]
LCSurplus <- as.data.frame(read_excel(Current_month_file, sheet = "Surplus.AnnualSurplusFlag"))
